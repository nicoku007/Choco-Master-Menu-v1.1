...
namespace ChocoMasterMenu
{
    public partial class Form1 : Form
    {
        ...
        {
          System.Drawing.Color.Black,       System.Drawing.Color.Navy,        System.Drawing.Color.Green,       System.Drawing.Color.Teal,
        ...
        private void PatchWadMapSlot(string tempWadPath, string oldSlot, string newSlot)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Error patching binary WAD: {ex.Message}");
            }
        }
      ...
      System.Windows.Forms.CheckBox playDemoCheck)
        {
            ...
            try
            {
                ...
                "TEETH.WAD"      
                    ...
                    string resourceCieloPath = "ChocoMasterMenu.SKYBLUE.wad";
            ...
            {
                MessageBox.Show($"Error launching custom marathon: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        "Black", "Blue (Navy)", "Green", "Cyan (Teal)",
        ...
        private void ActualizarNombreJugador(string nuevoNombre)
        {
            ...
            string rutaLocalConfig = Path.Combine(Directory.GetCurrentDirectory(), "chocolate-doom.cfg");
        ...
        private void button23_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error starting Chocolate Doom: The system cannot find the specified file.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
